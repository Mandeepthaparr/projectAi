...
def app():  
    ...
    # to give headers
    st.markdown("<h2 style='text-align: center; color: white;'>Discover Your Next Favorite Movie</h2>", unsafe_allow_html=True)
    st.markdown("<h3 style='text-align: center; color: white;'>Get personalized movie recommendations based on your taste!</h3>", unsafe_allow_html=True)
...
# Function to create a counter animation
    ...
    * special categories: movies based on true stories or books, Spy Movies, Cop Movies, Heist Movies, Girl Power Movies, Racing Movies, Space Movies, Wedding Movies, IMDb Top 250 movies, movies set in New York, movies set in Las Vegas, movies that may change the way you look at life …
    ...
    <div class="footer">
        <p>© 2025 CINESmart AI | <a href="https://github.com/Mandeepthaparr" target="_blank">GitHub</a> | 
